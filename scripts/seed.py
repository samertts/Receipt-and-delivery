...
ORG_NAMES = [
    "مختبر بغداد المركزي", "مختبر الكرخ", "مختبر الرصافة",
    "مختبر الموصل", "مختبر البصرة", "مختبر أربيل",
    "مختبر كركوك", "مختبر النجف", "مختبر كربلاء",
    "مختبر السليمانية", "مختبر دهوك", "مختبر الحلة",
    "مختبر العمارة", "مختبر الديوانية", "مختبر الكوت",
    "مختبر تكريت", "مختبر الرمادي", "مختبر السماوة",
    "مختبر الناصرية", "مختبر بابل", "مختبر واسط",
    "مختبر ذي قار", "مختبر المثنى", "مختبر القادسية",
    "مختبر ميسان", "مختبر صلاح الدين", "مختبر الأنبار",
    "مختبر نينوى", "مختبر تأميم", "مختبر حلبجة",
    "مختبر كركوك الصحي", "مختبر البصرة المركزي",
    "مختبر الموصل المركزي", "مختبر الفرات الأوسط",
    "مختبر بغداد الدولي",
]
...
GOVERNORATES = [
    ...
    "نينوى", "البصرة", "أربيل",
    "كركوك", "النجف", "كربلاء",
    "السليمانية", "دهوك", "بابل",
    "ميسان", "القادسية", "واسط",
    "صلاح الدين", "الأنبار", "المثنى",
    "ذي قار", "بابل", "واسط",
    "ذي قار", "المثنى", "القادسية",
    "ميسان", "صلاح الدين", "الأنبار",
    "نينوى", "كركوك", "حلبجة",
    "كركوك", "البصرة",
    "نينوى", "النجف",
    "بغداد",
