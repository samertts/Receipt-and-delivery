...
const AR = {
  ...
  nav: { operations: 'العمليات', admin: 'الإدارة', reports: 'التقارير', system: 'النظام', dashboard: 'لوحة التحكم', transactions: 'المعاملات', newTransaction: 'معاملة جديدة', organizations: 'المؤسسات', auditLogs: 'سجل التدقيق', reportsTitle: 'التقارير', settings: 'الإعدادات', devices: 'الأجهزة' },
  ...
  settings: { title: 'الإعدادات', noPermission: 'ليس لديك صلاحية الوصول إلى هذه الصفحة', userManagement: 'إدارة المستخدمين', addUser: 'إضافة مستخدم جديد', username: 'اسم المستخدم', fullName: 'الاسم الكامل', password: 'كلمة المرور', role: 'الصلاحية', status: 'الحالة', userCreated: 'تم إنشاء المستخدم بنجاح', allRoles: 'كل الأدوار', allStatuses: 'كل الحالات', activate: 'تفعيل', deactivate: 'تعطيل', editUser: 'تعديل المستخدم', saveChanges: 'حفظ التغييرات', userUpdated: 'تم تحديث المستخدم بنجاح', cannotDeactivateSelf: 'لا يمكن تعطيل المستخدم الحالي' },
  ...
  access: { forbidden: 'الوصول غير مسموح', forbiddenMessage: 'لا تملك الصلاحية اللازمة لعرض هذه الصفحة.', backToDashboard: 'العودة إلى لوحة التحكم' },
  devices: { title: 'مركز الأجهزة', subtitle: 'ربط الأجهزة الطرفية واستيراد البيانات إلى المعاملات', camera: 'الكاميرا والباركود', startCamera: 'تشغيل الكاميرا', stopCamera: 'إيقاف الكاميرا', cameraUnsupported: 'الكاميرا غير مدعومة في هذا المتصفح', barcodeResult: 'نتيجة الباركود', keyboardScanner: 'قارئ باركود USB', keyboardScannerHelp: 'يمكن للقارئ الذي يعمل كلوحة مفاتيح إرسال الرمز تلقائيًا إلى الحقل النشط.', lastScan: 'آخر قراءة', ocr: 'التعرف الضوئي OCR', chooseImage: 'اختر صورة', runOcr: 'تشغيل OCR', ocrProgress: 'جاري تحليل الصورة', ocrResult: 'النص المستخرج', nfc: 'NFC', readNfc: 'قراءة بطاقة NFC', nfcUnsupported: 'Web NFC غير مدعوم في هذا المتصفح', nfcResult: 'بيانات بطاقة NFC', printing: 'الطباعة', printTest: 'طباعة اختبار', bridge: 'الجسر المحلي', bridgeConnected: 'الجسر المحلي متصل', bridgeDisconnected: 'الجسر المحلي غير متصل', browserPrinting: 'الطباعة عبر المتصفح متاحة', permissionDenied: 'تم رفض إذن الجهاز', genericError: 'تعذر تشغيل الجهاز' },
...
const EN = {
  ...
  nav: { operations: 'Operations', admin: 'Administration', reports: 'Reports', system: 'System', dashboard: 'Dashboard', transactions: 'Transactions', newTransaction: 'New Transaction', organizations: 'Organizations', auditLogs: 'Audit Log', reportsTitle: 'Reports', settings: 'Settings', devices: 'Devices' },
  ...
  settings: { title: 'Settings', noPermission: 'You do not have permission to access this page', userManagement: 'User management', addUser: 'Add new user', username: 'Username', fullName: 'Full name', password: 'Password', role: 'Role', status: 'Status', userCreated: 'User created successfully', allRoles: 'All roles', allStatuses: 'All statuses', activate: 'Activate', deactivate: 'Deactivate', editUser: 'Edit user', saveChanges: 'Save changes', userUpdated: 'User updated successfully', cannotDeactivateSelf: 'You cannot deactivate the current user' },
  ...
  access: { forbidden: 'Access denied', forbiddenMessage: 'You do not have the required permission to view this page.', backToDashboard: 'Back to dashboard' },
  devices: { title: 'Device center', subtitle: 'Connect peripherals and import data into transactions', camera: 'Camera and barcode', startCamera: 'Start camera', stopCamera: 'Stop camera', cameraUnsupported: 'Camera access is not supported by this browser', barcodeResult: 'Barcode result', keyboardScanner: 'USB barcode scanner', keyboardScannerHelp: 'Keyboard-wedge scanners can send the code automatically to the active field.', lastScan: 'Last scan', ocr: 'Optical character recognition (OCR)', chooseImage: 'Choose image', runOcr: 'Run OCR', ocrProgress: 'Analyzing image', ocrResult: 'Extracted text', nfc: 'NFC', readNfc: 'Read NFC card', nfcUnsupported: 'Web NFC is not supported by this browser', nfcResult: 'NFC card data', printing: 'Printing', printTest: 'Print test', bridge: 'Local bridge', bridgeConnected: 'Local bridge connected', bridgeDisconnected: 'Local bridge disconnected', browserPrinting: 'Browser printing is available', permissionDenied: 'Device permission was denied', genericError: 'Unable to start the device' },
